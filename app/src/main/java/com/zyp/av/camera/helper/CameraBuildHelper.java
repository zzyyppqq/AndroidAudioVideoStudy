package com.zyp.av.camera.helper;
...
/**
 * Created by zzr on 2019/1/15.
 * 相机辅助类，和{@link CameraListener}共同使用，获取nv21数据等操作
 */

public class CameraBuildHelper implements Camera.PreviewCallback {
    ...
    private CameraBuildHelper(Builder builder) {
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        if (cameraListener != null) {
            cameraListener.onPreview(data.clone(), camera);
        }
    }
    ...
    public static final class Builder {
        ...
        public CameraBuildHelper build() {
            ...
            return new CameraBuildHelper(this);
        }
    }
}
