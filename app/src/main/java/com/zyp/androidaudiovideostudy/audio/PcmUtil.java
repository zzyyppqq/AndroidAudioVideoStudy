...
public class PcmUtil {
     ...
     * @param data
     */
    public static void pcmtoWav(String inputPath ,String outPath ,byte[] data,long longSampleRate, int channels){
        Log.d(TAG, "pcmtoWav: pcm="+inputPath+" , wav="+outPath);
     ...
     */
    private static byte[] generateWavFileHeader(long totalAudioLen, long longSampleRate, int channels) {
