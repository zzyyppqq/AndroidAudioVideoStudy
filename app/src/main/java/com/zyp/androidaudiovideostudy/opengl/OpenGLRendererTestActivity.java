...
import com.zyp.androidaudiovideostudy.gles.pbuffer.GLSurface;
import com.zyp.androidaudiovideostudy.gles.pbuffer.TestRenderer;
 ...
 */
public class OpenGLRendererTestActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opengl_renderer_test);

        SurfaceView sv = findViewById(R.id.sv_main_demo);
