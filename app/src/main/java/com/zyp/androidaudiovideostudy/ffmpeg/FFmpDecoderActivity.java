...
public class FFmpDecoderActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ffmpeg_decoder_test);
    ...
    public void clickOnSyncPlay(@SuppressLint("USELESS") View view) {
        ...
        syncPlayer = new SyncPlayer(FFmpDecoderActivity.this);
