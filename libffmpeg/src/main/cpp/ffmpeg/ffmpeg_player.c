...
Java_com_zyp_av_ffmpeg_FFPlayer_init(JNIEnv *env, jobject jobj, jstring input_jstr, jobject surface)
{
    gJNIEnv = env;
...
JNIEXPORT void JNICALL
Java_com_zyp_av_ffmpeg_FFPlayer_release(JNIEnv *env, jobject jobj)
{
    if(gJNIEnv!=NULL)
    {
...
Java_com_zyp_av_ffmpeg_FFPlayer_play(JNIEnv *env, jobject jobj)
{
...
JNIEXPORT jint JNICALL
Java_com_zyp_av_ffmpeg_FFPlayer_playMusic(JNIEnv *env, jobject instance, jstring media_input_jstr) {
