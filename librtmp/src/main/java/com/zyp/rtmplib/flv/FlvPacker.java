package com.zyp.rtmplib.flv;

import static com.zyp.rtmplib.flv.FlvPackerHelper.AUDIO_HEADER_SIZE;
import static com.zyp.rtmplib.flv.FlvPackerHelper.AUDIO_SPECIFIC_CONFIG_SIZE;
import static com.zyp.rtmplib.flv.FlvPackerHelper.FLV_HEAD_SIZE;
import static com.zyp.rtmplib.flv.FlvPackerHelper.FLV_TAG_HEADER_SIZE;
import static com.zyp.rtmplib.flv.FlvPackerHelper.PRE_SIZE;
import static com.zyp.rtmplib.flv.FlvPackerHelper.VIDEO_HEADER_SIZE;
import static com.zyp.rtmplib.flv.FlvPackerHelper.VIDEO_SPECIFIC_CONFIG_EXTEND_SIZE;
...
public class FlvPacker implements Packer, AnnexbHelper.AnnexbNaluListener{
    ...
    public void onAudioData(ByteBuffer bb, MediaCodec.BufferInfo bi) {
        ...
        Log.d("","Audio package size:"+dataSize);
