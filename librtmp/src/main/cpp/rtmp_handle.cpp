...
#define logw(content)   __android_log_write(ANDROID_LOG_WARN,"rtmp",content)
#define loge(content)   __android_log_write(ANDROID_LOG_ERROR,"rtmp",content)
#define logd(content)   __android_log_write(ANDROID_LOG_DEBUG,"rtmp",content)
...
Java_com_zyp_rtmplib_RtmpHandle_pushFile(JNIEnv *env, jobject thiz, jstring path_) {
...
Java_com_zyp_rtmplib_RtmpHandle_connect(JNIEnv *env, jobject thiz, jstring url_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zyp_rtmplib_RtmpHandle_push(JNIEnv *env, jobject thiz, jbyteArray buf_, jint length) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zyp_rtmplib_RtmpHandle_close(JNIEnv *env, jobject thiz) {
    if (rtmp != NULL) {
        RTMP_Close(rtmp);
        RTMP_Free(rtmp);
        rtmp = NULL;
