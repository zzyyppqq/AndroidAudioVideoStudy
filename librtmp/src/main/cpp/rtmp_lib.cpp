...
Java_com_zyp_rtmplib_RtmpLib_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_zyp_rtmplib_RtmpLib_rtmp_1pusher_1open(JNIEnv *env, jobject thiz, jstring url,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zyp_rtmplib_RtmpLib_rtmp_1pusher_1close(JNIEnv *env, jobject thiz) {
    return rtmp_sender_close();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_zyp_rtmplib_RtmpLib_rtmp_1pusher_1is_1connected(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zyp_rtmplib_RtmpLib_rtmp_1pusher_1push_1audio(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zyp_rtmplib_RtmpLib_rtmp_1pusher_1push_1video(JNIEnv *env, jobject thiz,
                                                                  jbyteArray data, jint size,
                                                                  jlong timestamp) {
    jbyte *bytes = env->GetByteArrayElements(data, JNI_FALSE);
    unsigned char *buffer = new unsigned char[size];
